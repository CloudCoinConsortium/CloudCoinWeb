 ...
 { 
     ...
     { 
          ...
          */ 
         function DetectionAgent(RAIDANumber, readTimeout) 
         { 
         ...
         */ 
         function Response echo(raidaID) 
         { 
          ...
          */ 
         function Response detect(nn, sn, an, pan, d) 
         { 
         ...
         * @return Response object.  
         */ 
         function Response get_ticket(nn, sn, an, d) 
         { 
          ...
          */ 
         function Response fix(triad, m1, m2, m3, pan) 
         { 
          ...
          */ 
         function ordinalIndexOf(str, substr, n) 
         { 
